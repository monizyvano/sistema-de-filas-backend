...
(function () {
    ...
    function atualizarDisplayAtual(senha) {
        ...
        if (currentPassword) {
            ...
            void currentPassword.offsetWidth; // reset animação
        ...
        const balcaoDisplay = document.getElementById('balcaoDisplay');
        if (balcaoDisplay) {
            const user = store.getUser();
            balcaoDisplay.textContent =
                `Balcão ${user.balcao || user.numero_balcao || 1}`;
        }
    ...
    function iniciarTimer() {
        ...
        timerInterval = setInterval(() => {
            ...
            const timerEl = document.getElementById('atendimentoTimer');
